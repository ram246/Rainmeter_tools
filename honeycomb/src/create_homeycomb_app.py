...
def download_images(app_name, icon, background):
    ...
    urllib.request.urlretrieve(icon, icon_file_path)
    ...
    urllib.request.urlretrieve(background, bgd_file_path)
...
if __name__ == '__main__':
    ...
    desktop_shortcut = str(sys.argv[2])
    icon_url = str(sys.argv[3])
    background_url = str(sys.argv[4])
